        ...
        <div class="force-overflow">
            <nav >
                <ul class="ul-elos">
                    ...
                    <div class="div-box"> <li class="a-box" ><a href="{{$var->alias}}" class="a-box" data-toggle="tooltip" data-placement="right" title="{{$var->alias}}"><img class="avatar-box img-circle" src="{{url('/') . $var->url_avatar}}"> {{$var->name}}</a></li></div>
                    @endforeach
